...
CONFIG: dict[str, Any] = {
    ...
    "rgb_input": "/workspace/on_veri/karlik_vadi_rgb.tif",
    # DTM raster yolu (1 band).
    "dtm_input": "/workspace/on_veri/karlik_vadi_dtm.tif",
    # DSM raster yolu (1 band).
    "dsm_input": "/workspace/on_veri/karlik_vadi_dsm.tif",
    # Uretilecek 5-band GeoTIFF yolu.
    "output": "/workspace/on_veri/karlik_vadi_rgb_dtm_dsm_5band.tif",
    # Cikti nodata degeri.
