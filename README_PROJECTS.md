...
├── archaeo_detect_base/      # 9 kanallı derin öğrenme yöntemi
...
**9 Kanallı Derin Öğrenme Yöntemi**

- **Girdi**: RGB + SVF + Openness + LRM + Slope + nDSM (9 kanal)
...
|---------|------|------|------|
| **Girdi Kanalları** | 9 (RGB + RVT) | Değişken | ALS tabanlı |
